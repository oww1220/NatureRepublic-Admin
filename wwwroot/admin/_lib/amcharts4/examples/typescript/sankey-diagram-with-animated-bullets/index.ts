...
chart.data = [
    ...
    { from: 'Globalworld', to: 'Cash in the U.S.', value: 10, color: '#f47b20' },
    {
        ...
        value: 75,
        color: '#f47b20',
        labelText: 'GLOBALWORLD [bold]$85[/]B',
        labelLocation: 0,
        labelRotation: 0,
    },
    ...
    },
    {
        from: 'Cash Overseas',
        color: '#000000',
        labelText: '[#f47b20 font-size:1.3em]CASH OVERSEAS\n[bold #f47b20 font-size:1.3em]$1,31 TRILLION',
        labelLocation: 0,
        labelRotation: -90,
        value: 1310,
    },
...
function firstHalfAnimation(bullet) {
    ...
    let animation = bullet.animate(
        [
            { property: 'locationX', from: 0.2, to: 0.5 },
            { property: 'opacity', from: 0, to: 0.3 },
        ],
        duration,
    );
...
function secondHalfAnimation(bullet, duration) {
    let animation = bullet.animate(
        [
            { property: 'locationX', from: 0.5, to: 0.8 },
            { property: 'opacity', from: 0.3, to: 0 },
        ],
        duration,
    );
    animation.events.on('animationended', (event) => {

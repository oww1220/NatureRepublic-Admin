...
function initSlider() {
    slider.events.on('rangechanged', function () {
        ...
        slider.background.fill = new am4core.Color(
            am4core.colors.interpolate(am4core.color('#676767').rgb, am4core.color('#7b131c').rgb, slider.start),
        );

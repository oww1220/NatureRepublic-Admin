...
networkSeries.data = [
    ...
    },
    {
        name: 'Monica',
        value: 204,
        linkWith: ['Rachel', 'Chandler', 'Ross', 'Joey', 'Phoebe'],
        children: [
            {
    ...
    },
    {
        name: 'Ross',
        value: 216,
        linkWith: ['Joey', 'Phoebe', 'Mrs Geller', 'Aunt Lilian', 'Mrs Bing', 'Ben', 'Mrs Green', 'Emily'],
        children: [
            {
                name: 'Carol',
                value: 10,
    ...
    },
    {
        name: 'Rachel',
        value: 158,
        linkWith: ['Chandler', 'Ross', 'Joey', 'Phoebe', 'Mr Geller', 'Mrs Geller'],
        children: [
            {
                name: 'Paolo',
                value: 5,
    ...
    },
    {
        name: 'Joey',
        value: 88,
        linkWith: ['Phoebe', 'Janice', 'Mrs Green', 'Kathy', 'Emily', 'Charlie'],
        children: [
            {
                name: 'Lorraine',
                value: 2,
